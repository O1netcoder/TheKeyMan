...
let progress = setInterval(()=>{
    ...
    sectionProgress.style.background = `conic-gradient(#191919  ${progressStartValue * 3.6}deg, #ffff00 0deg)`
...
let progress2 = setInterval(()=>{
    ...
    sectionProgress2.style.background = `conic-gradient(#191919  ${progressStartValue2 * 3.6}deg, #ffff00 0deg)`
...
let progress3 = setInterval(()=>{
    ...
    sectionProgress3.style.background = `conic-gradient(#191919  ${progressStartValue3 * 3.6}deg, #ffff00 0deg)`
